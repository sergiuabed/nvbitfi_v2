...
const char * instTypeNames[NUM_ISA_INSTRUCTIONS] = {
 ...
 const char * instTypeNames[NUM_ISA_INSTRUCTIONS] = {
 "FADD", "FADD32I", "FCHK", "FCMP", "FFMA", "FFMA32I", "FMNMX", "FMUL", "FMUL32I", "FSEL", "FSET", "FSETP", "FSWZ", "FSWZADD",
 "HADD2", "HADD2_32I", "HFMA2", "HFMA2_32I", "HMNMX2", "HMUL2", "HMUL2_32I", "HSET2", "HSETP2",
 "MUFU", "RRO",	
 "HMMA", "IMMA", "BMMA", "DMMA",
 "DADD", "DFMA", "DMNMX", "DMUL", "DSET", "DSETP",
 "BFE", "BFI", "BMSK", "BREV", "FLO",  "IABS", "IADD", "IADD3", "IADD32I", "ICMP", "IDP", "IDP4A", "IMAD", "IMAD32I", "IMADSP", "IMNMX", "IMUL", "IMUL32I", "IPA", "ISAD","ISCADD", "ISCADD32I", "ISET", "ISETP", "LEA", "LOP", "LOP3", "LOP32I", "POPC", "SHF", "SHL", "SHR", "XMAD",
 "VABSDIFF", "VABSDIFF4", "VADD", "VMAD", "VMNMX",  "VSET",  "VSETP", "VSHL",  "VSHR", 
 "F2F", "F2I", "I2F", "I2I", "I2IP", "I2FP", "F2IP", "FRND",
 "MOV", "MOV32I", "MOVM", "PRMT", "SEL", "SGXT", "SHFL",
 "PLOP3", "CSET", "CSETP", "PSET", "PSETP", "P2R", "R2P",
 "LD", "LDC", "LDG", "LDGDEPBAR", "LDGSTS", "LDL", "LDS", "LDSM","LDSLK", "ST", "STG", "STL", "STS", "STSCUL", "MATCH", "QSPC", "ATOM", "ATOMS", "ATOMG", "RED", "CCTL", "CCTLL", "ERRBAR", "MEMBAR", "CCTLT",
 "R2UR", "REDUX", "S2UR", "UBMSK", "UBREV", "UCLEA", "UF2FP", "UFLO", "UIADD3", "UIADD3_64", "UIMAD", "UISETP", "ULDC", "ULEA", "ULOP", "ULOP3", "ULOP32I", "UMOV", "UP2UR", "UPLOP3", "UPOPC", "UPRMT", "UPSETP", "UR2UP", "USEL", "USGXT", "USHF", "USHL", "USHR", "VOTEU",
 "TEX", "TLD", "TLD4", "TMML", "TXA", "TXD", "TXQ", "TEXS", "TLD4S", "TLDS", "STP",
 "SUATOM", "SUCLAMP", "SUBFM", "SUEAU", "SULD", "SULDGA", "SUQUERY", "SURED", "SUST", "SUSTGA",
 "BMOV", "BPT", "BRA", "BREAK", "BRK", "BRX", "BRXU", "BSSY", "BSYNC", "CALL", "CAL", "CONT", "EXIT", "IDE", "JCAL", "JMP", "JMX", "JMXU", "KIL", "KILL", "LONGJMP", "NANOSLEEP", "PBK", "PCNT", "PEXIT", "PLONGJMP", "PRET", "RAM", "RET", "RPCMOV", "RTT", "SAM", "SSY", "SYNC", "WARPSYNC", "YIELD", 
 "B2R", "BAR", "CS2R", "CSMTEST", "DEPBAR", "GETLMEMBASE", "LEPC", "NOP", "PMTRIG", "R2B", "S2R", "SETCTAID", "SETLMEMBASE", "VOTE", "VOTE_VTG", "GETCRSPTR", "SETCRSPTR"
};
...
int fp32Inst[] = {
 ...
 MUFU, RRO, FADD, FADD32I, FCMP, FFMA, FFMA32I, FMNMX, FMUL, FMUL32I, FSEL, FSET, FSWZADD, IPA, DSET, FSWZ
 };

int ldInst[] = {
 LD, LDC, LDG, LDL, LDS, SULD, SUST, TLD, TLD4, TLD4S, TLDS, LDGSTS, LDSLK, LDGDEPBAR,
 };
...
int noDestInst[] = {
 ST, STG, STL, STS, RED, CCTL, CCTLL, ERRBAR, MEMBAR, CCTLT, SURED, SUST, STSCUL,
 // Control Instructions
 BRA, BRX, JMP, JMX, SSY, SYNC, CAL, JCAL, PRET, RET, BRK, PBK, CONT, PCNT, EXIT, PEXIT, LONGJMP, PLONGJMP, KIL, BSSY, BSYNC, BREAK, BPT, IDE, RAM, RTT, SAM, BRXU, CALL, JMXU, KILL,
...
int otherInst[] = {
 ...
 // MUFU, RRO, HADD2, HADD2_32I, HFMA2, HFMA2_32I, HMUL2, HMUL2_32I, HSET2, HSETP2,
  HADD2, HADD2_32I, HFMA2, HFMA2_32I, HMUL2, HMUL2_32I, HSET2, HSETP2, HMNMX2,
 // Integer Instructions
 IDP, IDP4A, BFE, BFI, BMSK, BREV, FLO, IABS, ISAD, IADD, IADD3, IADD32I, ICMP, IMAD, IMAD32I, IMADSP, IMNMX, IMUL, IMUL32I, ISCADD, ISCADD32I, ISET, LEA, LOP, LOP3, LOP32I, POPC, SHF, SHL, SHR, XMAD,
 // MMA instructions
 IMMA, HMMA, BMMA, DMMA, LDSM,
 // Video Instructions
 VABSDIFF, VADD, VMAD, VMNMX, VSET, VSHL, VSHR, VABSDIFF4,
 // Conversion Instructions
 F2F, F2I, I2F, I2I, I2IP, FRND, I2FP, F2IP,
 // Move Instructions
 MOV, MOV32I, PRMT, SEL, SGXT, SHFL, MOVM,
 // unified datapath 
  R2UR, REDUX, S2UR, UBMSK, UBREV, UCLEA, UF2FP, UFLO, UIADD3, UIADD3_64, UIMAD, UISETP, ULDC, ULEA, ULOP, ULOP3, ULOP32I, UMOV, UP2UR, UPLOP3, UPOPC, UPRMT, UPSETP, UR2UP, USEL, USGXT, USHF, USHL, USHR, VOTEU,
 // Predicate/CC Instructions
 CSET,  PSET, P2R, CSMTEST, VOTE_VTG,
 // Texture Instructions
 TEX, TMML, TXA, TXD, TXQ, TEXS, STP,
 // Graphics Load/Store Instructions
 // surface instructions
 SUCLAMP, SUBFM, SUEAU, SULDGA, SUQUERY, SUSTGA,
 // Compute Load/Store Instructions
 MATCH, QSPC, ATOM, ATOMS, SUATOM, ATOMG,
 // Miscellaneous Instructions
 RPCMOV, 
