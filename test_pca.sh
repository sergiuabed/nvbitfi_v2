...
####
# environment variables specifically for PCAHyperspectralClassifier
export PCA_HSC_PATH=$NVBITFI_HOME/test-apps/PCAHyperspectralClassifier

# this is an environmental variable storing the path to the checkpoints of the Li et al model
export LI_MODEL_CHECKPOINTS_PATH=$PCA_HSC_PATH/models
export DATASETS_PATH=$PCA_HSC_PATH/Datasets
####
...
cd test-apps/PCAHyperspectralClassifier/
make PCAHyperspectralClassifier 2> stderr.txt
make golden
cd $CWD
